...
class ModelGeneratorTest extends TestCase
{
    ...
    */
     ...
     * @test
     */
    public function output_generates_models_with_custom_pivot_with_using()
    {
        $this->files->expects('stub')
            ->with('model/class.stub')
            ->andReturn(file_get_contents('stubs/model/class.stub'));
        ...
        $this->files->expects('put')
            ->with('app/User.php', $this->fixture('models/custom-pivot-column-using.php'));

        $tokens = $this->blueprint->parse($this->fixture('definitions/custom-pivot-column-using.bp'));
        $tree = $this->blueprint->analyze($tokens);
