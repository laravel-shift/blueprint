...
class JobGeneratorTest extends TestCase
{
    ...
    public function output_writes_nothing_tree_without_validate_statements()
    {
        ...
        $tokens = $this->blueprint->parse($this->fixture('definitions/render-statements-draft.yaml'));
    ...
    public function output_writes_jobs()
    {
        ...
        $tokens = $this->blueprint->parse($this->fixture('definitions/dispatch-statements-draft.yaml'));
        $tree = $this->blueprint->analyze($tokens);
