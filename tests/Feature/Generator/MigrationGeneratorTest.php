...
class MigrationGeneratorTest extends TestCase
{
    ...
    public function output_writes_migration_for_foreign_shorthand()
    {
        ...
        $tokens = $this->blueprint->parse($this->fixture('definitions/foreign-key-shorthand-draft.yaml'));
        $tree = $this->blueprint->analyze($tokens);
    ...
    public function output_uses_past_timestamp_for_multiple_migrations()
    {
        ...
        $tokens = $this->blueprint->parse($this->fixture('definitions/multiple-models-draft.yaml'));
        $tree = $this->blueprint->analyze($tokens);
    ...
    public function output_uses_proper_data_type_for_id_columns_in_laravel6()
    {
        ...
        $tokens = $this->blueprint->parse($this->fixture('definitions/model-identities-draft.yaml'));
        $tree = $this->blueprint->analyze($tokens);
    ...
    public function output_creates_constraints_for_unconventional_foreign_reference_migration()
    {
        ...
        $tokens = $this->blueprint->parse($this->fixture('definitions/relationships-draft.yaml'));
        $tree = $this->blueprint->analyze($tokens);
    ...
    public function output_also_creates_pivot_table_migration()
    {
        ...
        $tokens = $this->blueprint->parse($this->fixture('definitions/belongs-to-many-draft.yaml'));
        $tree = $this->blueprint->analyze($tokens);
    ...
    public function output_does_not_duplicate_pivot_table_migration()
    {
        ...
        $tokens = $this->blueprint->parse($this->fixture('definitions/belongs-to-many-duplicated-pivot-draft.yaml'));
        $tree = $this->blueprint->analyze($tokens);
    ...
    public function output_also_creates_pivot_table_migration_with_custom_name()
    {
        ...
        $tokens = $this->blueprint->parse($this->fixture('definitions/custom-pivot-table-name-draft.yaml'));
        $tree = $this->blueprint->analyze($tokens);
    ...
    public function output_creates_foreign_keys_with_nullable_chained_correctly()
    {
        ...
        $tokens = $this->blueprint->parse($this->fixture('definitions/nullable-chaining-draft.yaml'));
        $tree = $this->blueprint->analyze($tokens);
    ...
    public function output_creates_foreign_keys_with_on_delete()
    {
        ...
        $tokens = $this->blueprint->parse($this->fixture('definitions/foreign-key-on-delete-draft.yaml'));
        $tree = $this->blueprint->analyze($tokens);
    ...
    public function output_works_with_polymorphic_relationships()
    {
        ...
        $tokens = $this->blueprint->parse($this->fixture('definitions/polymorphic-relationships-draft.yaml'));
        $tree = $this->blueprint->analyze($tokens);
    ...
    {
        return [
            ['definitions/readme-example-draft.yaml', 'database/migrations/timestamp_create_posts_table.php', 'migrations/readme-example.php'],
            ['definitions/model-identities-draft.yaml', 'database/migrations/timestamp_create_relationships_table.php', 'migrations/identity-columns.php'],
            ['definitions/model-modifiers-draft.yaml', 'database/migrations/timestamp_create_modifiers_table.php', 'migrations/model-modifiers.php'],
            ['definitions/soft-deletes-draft.yaml', 'database/migrations/timestamp_create_comments_table.php', 'migrations/soft-deletes.php'],
            ['definitions/with-timezones-draft.yaml', 'database/migrations/timestamp_create_comments_table.php', 'migrations/with-timezones.php'],
            ['definitions/relationships-draft.yaml', 'database/migrations/timestamp_create_comments_table.php', 'migrations/relationships.php'],
            ['definitions/unconventional-draft.yaml', 'database/migrations/timestamp_create_teams_table.php', 'migrations/unconventional.php'],
            ['definitions/optimize-draft.yaml', 'database/migrations/timestamp_create_optimizes_table.php', 'migrations/optimize.php'],
            ['definitions/model-key-constraints-draft.yaml', 'database/migrations/timestamp_create_orders_table.php', 'migrations/model-key-constraints.php'],
            ['definitions/disable-auto-columns-draft.yaml', 'database/migrations/timestamp_create_states_table.php', 'migrations/disable-auto-columns.php'],
            ['definitions/uuid-shorthand-draft.yaml', 'database/migrations/timestamp_create_people_table.php', 'migrations/uuid-shorthand.php'],
            ['definitions/unconventional-foreign-key-draft.yaml', 'database/migrations/timestamp_create_states_table.php', 'migrations/unconventional-foreign-key.php'],
            ['definitions/resource-statements-draft.yaml', 'database/migrations/timestamp_create_users_table.php', 'migrations/resource-statements.php'],
        ];
    }
}
