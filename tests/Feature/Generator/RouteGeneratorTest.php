...
class RouteGeneratorTest extends TestCase
{
    ...
    public function output_generates_api_routes()
    {
        ...
        $tokens = $this->blueprint->parse($this->fixture('definitions/api-routes-example-draft.yaml'));
        $tree = $this->blueprint->analyze($tokens);
    ...
    public function output_generates_routes_for_mixed_resources()
    {
        ...
        $tokens = $this->blueprint->parse($this->fixture('definitions/multiple-resource-controllers-draft.yaml'));
        $tree = $this->blueprint->analyze($tokens);
    ...
    {
        return [
            ['definitions/readme-example-draft.yaml', 'routes/readme-example.php'],
            ['definitions/cruddy-draft.yaml', 'routes/cruddy.php'],
            ['definitions/non-cruddy-draft.yaml', 'routes/non-cruddy.php'],
            ['definitions/respond-statements-draft.yaml', 'routes/respond-statements.php'],
        ];
    }
}
