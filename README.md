...
## Requirements
Blueprint requires a Laravel application running a stable release of Laravel 11.x or ^10.38.
...
## Support Policy
Blueprint only generates code for the latest stable versions of Laravel (currently Laravel 10 and 11). If you need to support older versions of Laravel, you may use an older version of this package or upgrade your application ([try using Shift](https://laravelshift.com)).
